...
hit_dict_tmp = {
    ...
    'data': '/uploads/2c9180826e63806a016e6382709f0002/fddc7385-a43b-4ffe-bdb5-65768b6ff1a6___img2_2007_000175.jpg',  # text
    'extras': None,  # text
...
hit_result_dict_tmp = {
    ...
    'timeTakenToLabelInSec': 15,  # int(11) unsigned todo: a spotlight in frontend
    'notes': None,  # text
    'created_timestamp': datetime(2019, 11, 13, 13, 10, 36),  # timestamp, sql result 直接是 datetime
    'updated_timestamp': datetime(2019, 11, 13, 13, 10, 36),  # timestamp
}
