function choose_dataset(url) {
    $.ajax({
        ...
        success: function (dt_name) {
            ...
            show_dataset_chart(url.replace('choose', 'datasets'))
        }
    });
}

function reload_dataset(url) {
    $.ajax({
        type: "post",
        url: url,
        async: true,
        success: function () {
            $('.table .table-bordered .table-striped').load(location.href + ' #dt_table'); // must use all class tages
            console.log('reload done!');
            choose_dataset(url.replace('reload', 'choose'))
        }
    });
}
...
// todo: img gallery
function show_dataset_tags() {

}

function show_dataset_chart(url) {
    $.ajax({
        type: "post",
        url: url,
        async: true,
